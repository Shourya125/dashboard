...
import { ArrowRight, Scale, BookOpen, Search, Filter } from "lucide-react";


export default function Home() {
  const router = useRouter();
  const [data, setData] = useState<any>({ livelaw: [], ichr: [] });
    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
      ...
      <div className="text-center mb-16">
        ...
        <p className="max-w-2xl mx-auto text-xl text-gray-500 dark:text-gray-400">
          A unified platform to manage Livelaw legal intelligence and ICHR historical research data.
        </p>
      ...
      {loading ? (
        ...
        <div className="space-y-16">
          ...
          {!data.livelaw?.length && !data.ichr?.length && (
